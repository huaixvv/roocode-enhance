...
if ! code --list-extensions 2>/dev/null | grep -q "PayPalIntegrate.paypal-roocode-enhance"; then
  code --install-extension PayPalIntegrate.paypal-roocode-enhance &>/dev/null || exit 1
fi
